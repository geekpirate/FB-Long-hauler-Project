...
stopword += ['within', 'without', 'would', 'yet', 'you', 'your', 'pray', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday']
  ...
  for i in range(len(text_tokens)-1):
    ...
    if i < len(text_tokens)-3:
      if ((nltk.pos_tag(trigram[0][i])[0][1])+(nltk.pos_tag(trigram[0][i])[1][1])+(nltk.pos_tag(trigram[0][i])[2][1])) in tripattern:
        ...
        #symptomBag.append(nltk.pos_tag(trigram[0][i])[0][0] + " " + nltk.pos_tag(trigram[0][i])[1][0] + " " + nltk.pos_tag(trigram[0][i])[2][0])
...
file1 = open("C:/Users/sairo/Documents/ark/Project/DE/Posts_csv/Survior Corps_Posts/Symptoms_1_1 - 1_2 Survivor Corp.txt","w")
